...
anova(reduced,full)
#P-value is greater than .05, indicating little relationship. Therefore I get rid of the generosity and trust..government.corruption variables in the model
summary(reduced)
